...
def unet_exp_2(size_x, size_y, size_z):
    ...
    up_1 = concatenate([conv_2, up_1], axis=4)
    conv_4 = Conv3D(int(32*filters_mult), kernel_size, activation='relu', padding='same', kernel_initializer='he_normal')(up_1)
    conv_4 = Dropout(dropout)(conv_4)
    conv_4 = SpatialDropout3D(dropout_3d)(conv_4)
    conv_4 = Conv3D(int(32*filters_mult), kernel_size, activation='relu', padding='same', kernel_initializer='he_normal')(conv_4)

    #
    up_2 = UpSampling3D(size=2)(conv_4)
    up_2 = concatenate([conv_1, up_2], axis=4)
    conv_5 = Conv3D(int(16*filters_mult), kernel_size, activation='relu', padding='same', kernel_initializer='he_normal')(up_2)
    conv_5 = Dropout(dropout)(conv_5)
    conv_5 = SpatialDropout3D(dropout_3d)(conv_5)
    conv_5 = Conv3D(int(16*filters_mult), kernel_size, activation='relu', padding='same', kernel_initializer='he_normal')(conv_5)
